...
use linux_raw_sys::general::{
    ...
    __NR_pwrite64, __NR_read, __NR_readlinkat, __NR_sched_yield, __NR_set_tid_address,
    ...
    F_GETFD, F_GETFL, F_GETLEASE, F_GETOWN, F_GETSIG, F_SETFD, F_SETFL, PR_SET_NAME, TCGETS,
